...
def ShowFrame():
    ...
    #=================================進攻前面色塊=================================#
        ...
        free_kick_target_1=(582,213)#left
        free_kick_target_2=(582,265)
        free_kick_target_3=(582,315)

        free_kick_target_4=(70,213)#right
        free_kick_target_5=(70,265)
        free_kick_target_6=(70,315)
        
        a=(596,256)#target
        b=(470,237)#green ball
        cv2.line(img,b,a,(0,255,0),2)#gt
        cv2.line(img,body,face,(0,0,255),2)#pr
        cv2.line(img,center,a,(0,0,255),2)#ct
        cv2.line(img,center,b,(0,255,0),2)#cg
        
        cv2.circle(img,target,8,(255,255,0),-1)
        #cv2.circle(img,free_kick_target_1,8,(255,255,0),-1)
        #cv2.circle(img,free_kick_target_2,8,(255,255,0),-1)
        #cv2.circle(img,free_kick_target_3,8,(255,255,0),-1)
...
def Attack1():
    ...
    while(true == 1):
        ...
        if not centroid_x1 is None and not centroid_y1 is None and not centroid_x2 is None and not centroid_y2 is None:
            ...
            '''
            Green = np.array([470,236])
            Target = np.array([601,250])#球門
